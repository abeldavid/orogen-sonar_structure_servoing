...
#ifndef SONAR_STRUCTURE_SERVOING_TASK_TASK_HPP
#define SONAR_STRUCTURE_SERVOING_TASK_TASK_HPP

#include "sonar_structure_servoing/TaskBase.hpp"
#include <sonar_detectors/StructureEstimation.hpp>
...
namespace sonar_structure_servoing {
     ...
     * The name of a TaskContext is primarily defined via:
     ...
     deployment 'deployment_name'
         task('custom_task_name','sonar_structure_servoing::Task')
     end
     \endverbatim
	...
	States last_state;
	States new_state;
	sonar_detectors::StructureEstimation estimator;
	base::Angle relative_target_heading;
    ...
    public:
         ...
         */
        Task(std::string const& name = "sonar_structure_servoing::Task");
